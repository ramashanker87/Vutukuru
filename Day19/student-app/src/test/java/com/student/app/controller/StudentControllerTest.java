...
//    assertEquals("", result);
  ...
  public void testdeleteStudent() throws Exception {
    ...
    ResultActions resultActions2 = mockMvc.perform(post("/save/student")
            ...
            .accept(MediaType.APPLICATION_JSON));
    resultActions2.andExpect(status().isOk());
    ResultActions resultActions3 = mockMvc.perform(post("/save/student")
            .contentType(MediaType.APPLICATION_JSON).content(asJsonString(student3))
            .accept(MediaType.APPLICATION_JSON));
    resultActions3.andExpect(status().isOk());

    ResultActions resultGetActionsd = mockMvc.perform(delete("/delete/student")
                    .param("name","student3"));
    resultGetActionsd.andExpect(status().isOk());
  }
