...
@Configuration
public class DoctorSqsService {
    private static final Logger log = LoggerFactory.getLogger(DoctorSqsService.class);
    private final SqsAsyncClient sqsAsyncClient;
    private final ObjectMapper objectMapper;

    public DoctorSqsService(SqsAsyncClient sqsAsyncClient, ObjectMapper objectMapper) {
